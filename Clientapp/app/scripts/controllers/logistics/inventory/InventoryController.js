(function(module) {
  mifosX.controllers = _.extend(module, {
    InventoryController: function(scope,webStorage, routeParams, location,$modal, resourceFactory, paginatorService,PermissionService,route,$rootScope,dateFilter) {
        scope.items = [];
        scope.grn = [];
        scope.itemdetails = [];
        scope.mrn = [];
				  		...
				  		scope.searchSupplier = function(filterText) {
							...
							scope.editQuality = function(itemId,valueQuality,provisionalserialNum,serialNumber){
					          ...
					          scope.editProvSerial= function(itemId,valueQuality,provisionalserialNum){
						       ...
						       var EditGRNQualityController = function ($scope, $modalInstance,grndata) {
						    	   $scope.formData = {};
  ...
  mifosX.ng.application.controller('InventoryController', ['$scope','webStorage', '$routeParams', '$location','$modal', 'ResourceFactory','PaginatorService','PermissionService','$route','$rootScope', 'dateFilter',mifosX.controllers.InventoryController]).run(function($log) {
