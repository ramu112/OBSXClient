(function(module) {
  mifosX.controllers = _.extend(module, {
    ClientController: function(scope, resourceFactory , paginatorService,location,PermissionService,webStorage,$modal,$sce,TENANT) {
  ...
  mifosX.ng.application.controller('ClientController', ['$scope', 'ResourceFactory', 'PaginatorService','$location','PermissionService','webStorage','$modal','$sce','TENANT',mifosX.controllers.ClientController]).run(function($log) {
