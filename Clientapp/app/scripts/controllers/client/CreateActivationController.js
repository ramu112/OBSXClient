...
//create client controller
		  ...
		  scope.changeServiceFun = function(){
			  resourceFactory.clientserviceparamResource.get({serviceId: scope.serviceFormData.serviceId}, function(data) {
          ...
          scope.selectPairableItemDetails = function(pairableSerialNo){
          	...
          	resourceFactory.itemMasterDetailTemplateResource.get({query : scope.pairableSerialNo,clientId:scope.clientId},function(data) {
          		if(data){
		        		   scope.pairableItemId = data.id;
