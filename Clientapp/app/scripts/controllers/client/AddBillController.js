(function(module) {
	  mifosX.controllers = _.extend(module, {
		  AddBillController: function(scope, webStorage,routeParams , location, resourceFactory,dateFilter,
				  																	$rootScope,API_VERSION,http) {
			  scope.reset123 = function(){
		        	webStorage.add("callingTab", {someString: "billingtab" });
		         };
	  ...
	  mifosX.ng.application.controller('AddBillController', [
	                                                           '$scope',
	                                                           'webStorage',
	                                                           '$routeParams',
	                                                           '$location',
	                                                           ...
	                                                           'API_VERSION',
	                                                           '$http',
	                                                           mifosX.controllers.AddBillController]).run(function($log) {
        $log.info("AddBillController initialized");
    });
}(mifosX.controllers || {}));