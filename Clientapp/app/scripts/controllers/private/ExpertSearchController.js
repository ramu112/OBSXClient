(function (module) {
    mifosX.controllers = _.extend(module, {
        ExpertSearchController: function (scope, resourceFactory, location,localStorageService,$modal) {
           ...
           //count duplicates for clients
        	...
        	function searchClientCtrl($scope, $modalInstance) {
    ...
    mifosX.ng.application.controller('ExpertSearchController', ['$scope', 'ResourceFactory', '$location','localStorageService','$modal', mifosX.controllers.ExpertSearchController]).run(function ($log) {
