  ...
  var defineRoutes = function($routeProvider, $locationProvider) {
    $routeProvider
      ...
      .when('/editplan/:id', {
       ...
       .when('/neworder/:planId/:id/:clientServiceId', {
     ...
     templateUrl: 'views/organization/redemption.html'
      ...
      .when('/adddevice/:clientId/:officeId/:clientServiceId', {
      ...
      .when('/viewclientservice/:clientId/:id', {
        templateUrl: 'views/clients/viewclientservice.html'
      })
      .when('/clientservice/:clientId', {
        templateUrl: 'views/clients/clientservice.html'
      })
      ...
      .when('/addbill/:id', {
        ...
        .when('/provisioningdetails', {
          templateUrl : 'views/administration/provisioningdetails.html'
        })
        .when('/broadcaster', {
          templateUrl : 'views/organization/Broadcaster/broadCaster.html'
        })
      .when('/createbroadcaster', {
          templateUrl : 'views/organization/Broadcaster/createBroadcaster.html'
        })
        .when('/viewbroadcaster/:id', {
          templateUrl : 'views/organization/Broadcaster/viewbroadcaster.html'
        })
       .when('/editbroadcaster/:id', {
          templateUrl : 'views/organization/Broadcaster/editbroadcaster.html'
        })
        .when('/channel', {
          templateUrl : 'views/organization/channel/channel.html'
        })
         .when('/createChannel', {
          templateUrl : 'views/organization/channel/createChannel.html'
        })
        .when('/viewChannel/:id', {
          templateUrl : 'views/organization/channel/viewChannel.html'
        })
        .when('/editchannel/:id', {
          templateUrl : 'views/organization/channel/editChannel.html'
        })
        .when('/testsample', {
          templateUrl : 'views/organization/testsample.html'
        })
        .when('/simpleActivation', {
        templateUrl: 'views/clients/createsimpleactivation.html'  
        })
        .when('/broadcasterchannelmapping', {
          templateUrl : 'views/organization/broadcasterchannelmapping.html'
        })
        .when('/ChannelMapping', {
          templateUrl : 'views/organization/channelmapping/ChannelMapping.html'
        })
        .when('/createChannelMapping', {
          templateUrl : 'views/organization/channelmapping/createChannelMapping.html'
        })
        .when('/ViewChannelMapping/:id', {
          templateUrl : 'views/organization/channelmapping/ViewChannelMapping.html'
        })
        .when('/EditChannelMapping/:id', {
          templateUrl : 'views/organization/channelmapping/EditChannelMapping.html'
        })
