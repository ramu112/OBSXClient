        ...
        addCityResource: defineResource(apiVer + "/address/city/new",{},  {
          ...
          itemSaleResource: defineResource(apiVer + "/itemsales", {}, {
            ...
            clientserviceparamResource:defineResource(apiVer + "/clientservice/servicedetails/:serviceId", {serviceId:'@serviceId'}, {
             ...
             viewClientServiceResource:defineResource(apiVer + "/clientservice/:clientId/:id", {clientId:'@clientId', clientserviceId:'@clientserviceId'}, {
             	  get: {method: 'GET', params: {}},
             }),
             provisioningRequestResource:defineResource(apiVer + "/provisioningrequest/:orderId", {orderId:'@orderId'}, {
             	  get: {method: 'GET', params: {}},
             }),
